 ...
 */
export class TpPosicaoCirurgica extends GenericDomain{
    constructor(
        id?: string,
    ...
    static fromJson(jsonData: any): TpPosicaoCirurgica {
        return Object.assign(new TpPosicaoCirurgica(), jsonData);
    }
}